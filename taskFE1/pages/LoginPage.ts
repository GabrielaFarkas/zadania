...
export class LoginPage extends BasePage {
    ...
    constructor(page:Page) {
     ...
     this.errorMessageBoxColor = page.locator('div.error-message-container.error');
     this.inventoryUrl = 'https://www.saucedemo.com/inventory.html';
    }


    private async expectErrorMessageBoxColor(): Promise <void>{
        await expect(this.errorMessageBoxColor).toHaveCSS('background-color', 'rgb(226, 35, 26)');
    }
